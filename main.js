/* ============================================================
   孙新成 · 个人作品集交互
   - 导航栏滚动效果 / 移动端菜单 / 主题切换
   - 滚动高亮（scrollspy）/ 返回顶部 / 入场动画
   - 构建：修改本文件后运行 `python tools/build.py` 生成 main.min.js
   ============================================================ */
(function () {
    'use strict';
    ...
    /* ---------- 卡片入场动画 ---------- */
    var revealEls = document.querySelectorAll('.work-card, .about-card');
